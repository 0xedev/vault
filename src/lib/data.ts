...
export const OTC_FIATS: OTCFiat[] = [
  ...
  { code: "ARS", sym: "$",  name: "Argentine Peso" },
];

export interface OTCCrypto {
  code: string;
  name: string;
  market: Record<string, number>;
}

export const OTC_CRYPTOS: OTCCrypto[] = [
  { code: "USDC", name: "USDC", market: { USD: 1.001, EUR: 0.92, NGN: 1640, INR: 83.4, BRL: 5.07, ARS: 1024 } },
  { code: "USDT", name: "Tether", market: { USD: 1.000, EUR: 0.92, NGN: 1644, INR: 83.5, BRL: 5.06, ARS: 1023 } },
  { code: "ETH",  name: "Ethereum", market: { USD: 3450, EUR: 3174, NGN: 5660000, INR: 287900, BRL: 17480, ARS: 3534000 } },
  { code: "BTC",  name: "Bitcoin", market: { USD: 67800, EUR: 62380, NGN: 111200000, INR: 5658000, BRL: 343500, ARS: 69470000 } },
];

export interface OTCPayment {
  id: string;
  t: string;
  fiat: string[];
}

export const OTC_PAYMENTS: OTCPayment[] = [
  { id: "sepa",   t: "SEPA Transfer",     fiat: ["EUR"] },
  { id: "ach",    t: "ACH",               fiat: ["USD"] },
  { id: "wire",   t: "Wire transfer",     fiat: ["USD", "EUR"] },
  { id: "revolut",t: "Revolut",           fiat: ["USD", "EUR"] },
  { id: "wise",   t: "Wise",              fiat: ["USD", "EUR", "INR", "BRL"] },
  { id: "paypal", t: "PayPal",            fiat: ["USD", "EUR"] },
  { id: "zelle",  t: "Zelle",             fiat: ["USD"] },
  { id: "venmo",  t: "Venmo",             fiat: ["USD"] },
  { id: "cashapp",t: "Cash App",          fiat: ["USD"] },
  { id: "mpesa",  t: "M-Pesa",            fiat: ["NGN"] },
  { id: "upi",    t: "UPI",               fiat: ["INR"] },
  { id: "pix",    t: "Pix",               fiat: ["BRL"] },
  { id: "mp",     t: "MercadoPago",       fiat: ["ARS", "BRL"] },
];
...
export const OTC_ADS: OTCAd[] = [
  { id: "AD-1244", merchant: "atlas_otc",   verified: "PRO",    rep: 99.6, trades: 4128, online: true,  crypto: "USDC", fiat: "USD", spread:  0.4, min: 200,    max: 50000,  payments: ["zelle","wire","ach"],         release: "auto", terms: "Zelle payments only. Auto-release on confirm. No 3rd-party.",  fastRelease: true,  type: "sell" },
  { id: "AD-1243", merchant: "kyiv_swap",   verified: "VERIFIED",rep: 98.2, trades: 1820, online: true,  crypto: "USDT", fiat: "EUR", spread:  0.7, min: 100,    max: 25000,  payments: ["sepa","revolut","wise"],       release: "auto", terms: "SEPA only. ID matching name required.", fastRelease: true, type: "sell" },
  { id: "AD-1242", merchant: "lagos_giant", verified: "PRO",    rep: 99.1, trades: 11240,online: true,  crypto: "USDC", fiat: "NGN", spread:  1.8, min: 50000,  max: 10000000,payments: ["mpesa","wire"],               release: "auto", terms: "Bank transfer 7am-10pm WAT. Mobile money 24/7.",  fastRelease: true, type: "sell" },
  { id: "AD-1241", merchant: "bombay_eth",  verified: "VERIFIED",rep: 96.4, trades: 612,  online: false, crypto: "ETH",  fiat: "INR", spread:  1.2, min: 25000,  max: 1500000,payments: ["upi","wise"],                  release: "manual",terms: "UPI only. No bank transfers.", fastRelease: false, type: "sell" },
  { id: "AD-1240", merchant: "rio_btc",     verified: "PRO",    rep: 99.8, trades: 6740, online: true,  crypto: "BTC",  fiat: "BRL", spread:  0.9, min: 1000,   max: 500000, payments: ["pix","wire"],                  release: "auto", terms: "Pix preferred. 30min payment window.",        fastRelease: true, type: "sell" },
  { id: "AD-1239", merchant: "carlos_ar",   verified: "VERIFIED",rep: 94.0, trades: 188,  online: true,  crypto: "USDT", fiat: "ARS", spread:  3.2, min: 100000, max: 50000000,payments: ["mp"],                       release: "manual",terms: "MercadoPago only. ID required for orders > 1M ARS.", fastRelease: false, type: "sell" },
  { id: "AD-1238", merchant: "atlas_otc",   verified: "PRO",    rep: 99.6, trades: 4128, online: true,  crypto: "USDC", fiat: "USD", spread: -0.3, min: 500,    max: 100000, payments: ["wire","ach"],                  release: "auto", terms: "Buying USDC. Wire only over $25k.",      fastRelease: true, type: "buy" },
  { id: "AD-1237", merchant: "kyiv_swap",   verified: "VERIFIED",rep: 98.2, trades: 1820, online: true,  crypto: "USDT", fiat: "EUR", spread: -0.5, min: 100,    max: 20000,  payments: ["sepa"],                        release: "auto", terms: "Buying USDT. SEPA only.", fastRelease: true, type: "buy" },
  { id: "AD-1236", merchant: "lagos_giant", verified: "PRO",    rep: 99.1, trades: 11240,online: true,  crypto: "USDC", fiat: "NGN", spread: -1.4, min: 100000, max: 5000000,payments: ["wire"],                       release: "auto", terms: "Buying USDC for naira. Same-day payout.", fastRelease: true, type: "buy" },
  { id: "AD-1235", merchant: "venice_v",    verified: "NEW",    rep: 91.0, trades: 38,   online: true,  crypto: "ETH",  fiat: "USD", spread:  1.5, min: 100,    max: 2000,   payments: ["paypal","cashapp"],            release: "manual",terms: "Friends & family only via PayPal.",       fastRelease: false, type: "sell" },
];
