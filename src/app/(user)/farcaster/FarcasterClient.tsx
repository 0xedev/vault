      ...
      .catch((err) => {
        setError(
          err instanceof Error
            ? err.message
            : "Unable to load Farcaster listings",
        );
        setLoading(false);
      });
  }, []);
    ...
    >
      ...
      >
        <div style={{ flex: "1 1 320px", minWidth: 0 }}>
          <div
            className="row"
            style={{ gap: 10, alignItems: "center", marginBottom: 4 }}
          >
            <img
              src="/farcaster.png"
              alt="Farcaster"
                ...
                >
                  <div className="x-head">
                    ...
                    <img
                      src="/farcaster.png"
                      alt=""
                      style={{ width: 24, height: 24, opacity: 0.72 }}
                    />
                  </div>
                  <div className="x-stats">
                    <div className="col" style={{ gap: 1 }}>
                      <span className="meta">Followers</span>
                      <span className="amt mono" style={{ fontSize: 14 }}>
                        {fmtCompact(a.followers)}
                      </span>
                    </div>
                    <div className="col" style={{ gap: 1 }}>
                      <span className="meta">Casts / 30d</span>
                      <span className="amt mono" style={{ fontSize: 14 }}>
                        {a.casts_30d}
                      </span>
                    </div>
                    <div className="col" style={{ gap: 1 }}>
                      ...
                      <span className="amt mono" style={{ fontSize: 14 }}>
                        {a.rev_30d > 0 ? fmtUSDC(a.rev_30d) : "0"}
                      </span>
                    </div>
                  </div>
                  <div
