  ...
  return (
    <div style={{ background: "rgba(255,255,255,0.02)", borderRadius: 8, padding: 12, border: "1px solid var(--line)" }}>
      <svg viewBox={`0 0 ${w} ${h}`} width="100%" height="64" preserveAspectRatio="none">
        ...
        <path d={path} stroke="#7CFFB2" strokeWidth="0.6" fill="none" vectorEffect="non-scaling-stroke" />
      </svg>
    </div>
  );
}
    ...
    <div className="card" style={{ padding: 18, position: "relative", overflow: "hidden" }}>
      <div className="row between" style={{ marginBottom: 14 }}>
        <div className="row" style={{ gap: 10 }}>
          ...
          <span className="smallcaps">Lender Dashboard · Apr 30</span>
        </div>
        <div className="seg">
  ...
  return (
    <main className="main">
      <section className="hero">
        <div>
          <div className="eyebrow">Lending · Escrow · CTO</div>
          <h1 className="h1" style={{ marginTop: 24 }}>
            Liquidity for <em>illiquid</em> digital assets.
          </h1>
          <p className="lede" style={{ margin: "28px 0 32px" }}>
            One venue for NFT-backed loans, mini-app sales, X handle transfers, and Farcaster FID escrow — all settled through audited multi-sig.
          </p>
      ...
      <section style={{ padding: "96px 0 48px" }}>
        <div style={{ marginBottom: 56, maxWidth: "42ch" }}>
          <div className="eyebrow">Four marketplaces, one settlement layer</div>
      ...
      <section style={{ padding: "32px 0 24px" }}>
        <div className="eyebrow">Live on Vault</div>
        ...
        <div className="card" style={{ padding: 32, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, alignItems: "center" }}>
          <div>
            ...
            <p className="muted" style={{ fontSize: 14, lineHeight: 1.6, maxWidth: "50ch" }}>
              We surface platform fees before signing, flash deadline countdowns when default is imminent, and
              gate liquidation behind a confirm-by-typing pattern. The goal: zero accidental losses.
            </p>
          </div>
      ...
      <footer className="row between" style={{ padding: "48px 0 0", color: "var(--ink-4)", fontSize: 12 }}>
        <div className="row" style={{ gap: 8 }}><VaultMark size={16} /> <span className="mono">vault.fi · v0.4.2 · audited by Trail of Bits</span></div>
        <div className="row" style={{ gap: 18 }}>
          <a className="lnk" href="#">Docs</a><a className="lnk" href="#">Risk</a><a className="lnk" href="#">Discord</a><a className="lnk" href="#">Status</a>
        </div>
      </footer>
    </main>
  );
